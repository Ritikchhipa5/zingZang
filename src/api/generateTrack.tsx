...
const createVideoSong = async () => {
  return await fetch(
    GENERATE_TRACK.VIDEO_CREATE +
      `?settings_json={"prompts":{"0":" tiny cute swamp bunny, highly detailed, intricate, ultra hd, sharp photo, crepuscular rays, in focus, 4k, landscape --neg nsfw, nude","30":" anthropomorphic clean cat, surrounded by mandelbulb fractals, epic angle and pose, symmetrical, 3d, depth of field --neg nsfw, nude","60":" a beautiful coconut --neg photo, realistic  nsfw, nude","90":" a beautiful durian, amazing award winning photography --neg nsfw, nude"}}
